        ...
        if (docInfo != null) {
            ...
            for (PdfName pdfName : docInfo.keySet()) {
                ...
                if (PdfName.Title.equals(key)) {
                    if(!xmpMeta.doesPropertyExist(XMPConst.NS_DC, PdfConst.Title)) {
                    ...
                    if(!xmpMeta.doesPropertyExist(XMPConst.NS_DC, PdfConst.Creator)) {
                    ...
                    if(!xmpMeta.doesPropertyExist(XMPConst.NS_DC, PdfConst.Description)) {
                    ...
                    if(!xmpMeta.doesPropertyExist(XMPConst.NS_DC, PdfConst.Subject)) {
                        for (String v : value.split(",|;")) {
                            if (v.trim().length() > 0) {
